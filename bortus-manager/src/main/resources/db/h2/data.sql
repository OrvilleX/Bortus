...
INSERT INTO `sys_menu` VALUES (2, 1, 3, 1, '用户管理', 'User', 'system/user/Index.vue', 2, 'peoples', 'user', '0', '0', '0', 'user:list', NULL, NULL, '2018-12-18 15:14:44', NULL);
...
INSERT INTO `sys_menu` VALUES (3, 1, 3, 1, '角色管理', 'Role', 'system/role/Index.vue', 3, 'role', 'role', '0', '0', '0', 'roles:list', NULL, NULL, '2018-12-18 15:16:07', NULL);
...
INSERT INTO `sys_menu` VALUES (5, 1, 3, 1, '菜单管理', 'Menu', 'system/menu/Index.vue', 5, 'menu', 'menu', '0', '0', '0', 'menu:list', NULL, NULL, '2018-12-18 15:17:28', NULL);
...
INSERT INTO `sys_menu` VALUES (28, 1, 3, 1, '任务调度', 'Timing', 'system/timing/Index.vue', 999, 'timing', 'timing', '0', '0', '0', 'timing:list', NULL, NULL, '2019-01-07 20:34:40', NULL);
...
INSERT INTO `sys_menu` VALUES (35, 1, 3, 1, '部门管理', 'Dept', 'system/dept/Index.vue', 6, 'dept', 'dept', '0', '0', '0', 'dept:list', NULL, NULL, '2019-03-25 09:46:00', NULL);
...
INSERT INTO `sys_menu` VALUES (37, 1, 3, 1, '岗位管理', 'Jo', 'system/job/Index.vue', 7, 'Steve-Jobs', 'jo', '0', '0', '0', 'job:list', NULL, NULL, '2019-03-29 13:51:18', NULL);
...
INSERT INTO `sys_menu` VALUES (39, 1, 3, 1, '字典管理', 'Dict', 'system/dict/Index.vue', 8, 'dictionary', 'dict', '0', '0', '0', 'dict:list', NULL, NULL, '2019-04-10 11:49:04', NULL);
...
INSERT INTO `sys_menu` VALUES (7, 6, 0, 1, '操作日志', 'Log', 'monitor/log/Index.vue', 11, 'log', 'logs', '0', '1', '0', NULL, NULL, 'admin', '2018-12-18 15:18:26', '2020-06-06 13:11:57');
INSERT INTO `sys_menu` VALUES (32, 6, 0, 1, '异常日志', 'ErrorLog', 'monitor/log/ErrorLog.vue', 12, 'error', 'errorLog', '0', '0', '0', NULL, NULL, NULL, '2019-01-13 13:49:03', NULL);
INSERT INTO `sys_menu` VALUES (41, 6, 0, 1, '在线用户', 'OnlineUser', 'monitor/online/Index.vue', 10, 'Steve-Jobs', 'online', '0', '0', '0', NULL, NULL, NULL, '2019-10-26 22:08:43', NULL);
...
INSERT INTO `sys_menu` VALUES (11, 10, 0, 1, '图标库', 'Icons', 'components/icons/Index.vue', 51, 'icon', 'icon', '0', '0', '0', NULL, NULL, NULL, '2018-12-19 13:38:49', NULL);
INSERT INTO `sys_menu` VALUES (15, 10, 0, 1, '富文本', 'Editor', 'components/Editor.vue', 52, 'fw', 'tinymce', '0', '0', '0', NULL, NULL, NULL, '2018-12-27 11:58:25', NULL);
INSERT INTO `sys_menu` VALUES (33, 10, 0, 1, 'Markdown', 'Markdown', 'components/MarkDown.vue', 53, 'markdown', 'markdown', '0', '0', '0', NULL, NULL, NULL, '2019-03-08 13:46:44', NULL);
INSERT INTO `sys_menu` VALUES (83, 10, 0, 1, '图表库', 'Echarts', 'components/Echarts.vue', 50, 'chart', 'echarts', '0', '1', '0', '', NULL, NULL, '2019-11-21 09:04:32', NULL);

INSERT INTO `sys_menu` VALUES (36, NULL, 7, 0, '系统工具', NULL, '', 30, 'sys-tools', 'sys-tools', '0', '0', '0', NULL, NULL, NULL, '2019-03-29 10:57:35', NULL);
INSERT INTO `sys_menu` VALUES (14, 36, 0, 1, '邮件工具', 'Email', 'tools/email/Index.vue', 35, 'email', 'email', '0', '0', '0', NULL, NULL, NULL, '2018-12-27 10:13:09', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 2, 'admin', '管理员', '男', '18888888888', 'admin@orvillex.com', 'avatar-20200806032259161.png', '/Users/jie/Documents/work/me/admin/eladmin/~/avatar/avatar-20200806032259161.png', '$2a$10$Egp1/gvFlt7zhlXVfEFw4OfWQCGPw0ClmMcc6FjTnvXNRVf9zdMRa', '1', 1, NULL, 'admin', '2020-05-03 16:38:31', '2018-08-23 09:11:56', '2020-09-05 10:43:31');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_job_group`(`group_id`, `app_name`, `title`, `address_type`, `address_list`, `is_deleted`) VALUES (1, 'job-executor-sample1', '示例执行器1', 0, NULL, 0);
INSERT INTO `sys_job_group`(`group_id`, `app_name`, `title`, `address_type`, `address_list`, `is_deleted`) VALUES (2, 'datapump-job-executor', '示例执行器2', 0, NULL, 0);
COMMIT;
