    ...
    public static Object parseFromString(String s, DataType sqlType) throws Exception {
        ...
        switch (sqlType.getName()) {
            ...
            case DATE: {
                ...
                return LocalDate.fromYearMonthDay(Integer.valueOf(a[0]), Integer.valueOf(a[1]), Integer.valueOf(a[2]));
            }
            case TIME:
                return Long.valueOf(s);
            case TIMESTAMP:
        ...
        switch (type.getName()) {
            ...
            case UDT: {
                ...
                for (JSONObject.Entry e : ((JSONObject) jsonObject).entrySet()) {
                    ...
                    t.set((String) e.getKey(), parseFromJson(e.getValue(), eleType),
                            registry.codecFor(eleType).getJavaType());
                }
                return t;
            }
        }
