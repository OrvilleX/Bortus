...
public class BoolColumn extends Column {
	...
	@Override
	public Date asDate() {
		throw new DataPumpException(I18nUtil.getString("CONVERT_NOT_SUPPORT") + ":Bool类型不能转为Date");
	}

	@Override
	public byte[] asBytes() {
		throw new DataPumpException(I18nUtil.getString("CONVERT_NOT_SUPPORT") + ":Boolean类型不能转为Bytes");
	}
	...
	private void validate(final String data) {
		...
		throw new DataPumpException(
				I18nUtil.getString("CONVERT_NOT_SUPPORT") + String.format(":String[%s]不能转为Bool .", data));
	}
}
